...
<header class="bg-dark py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">Autores</h1>
            <p class="lead fw-normal text-white-50 mb-0">Información de autores</p>
        </div>
    </div>
</header>
    ...
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
            ...
            try {
                ...
                // Mostrar tarjetas de autores
                foreach ($autores as $autor) {
                    echo '<div class="col mb-5">';
                    echo '    <div class="card h-100">';
                    echo '        <div class="card-body p-4">';
                    echo '            <div class="text-center">';
                    echo '                <h5 class="fw-bolder">' . $autor['nombre'] . ' ' . $autor['apellido'] . '</h5>';
                    echo '                <p class="card-text">Teléfono: ' . $autor['telefono'] . '</p>';
                    echo '                <p class="card-text">Dirección: ' . $autor['direccion'] . ', ' . $autor['ciudad'] . ', ' . $autor['estado'] . ', ' . $autor['pais'] . '</p>';
                    // Puedes agregar más detalles del autor si los tienes en tu base de datos
                    echo '            </div>';
                    echo '        </div>';
                    echo '        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">';
                    echo '            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="#">Ver más</a></div>';
                    echo '        </div>';
                    echo '    </div>';
                    echo '</div>';
                }
